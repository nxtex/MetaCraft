  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#080A0F' }}>
      ...
      <div className="max-w-[1800px] mx-auto px-8 py-8">
        ...
        {/* File queue */}
        {files.length > 0 && (
          <StratumCard className="p-6 mb-8">
        ...
        <div className="grid grid-cols-4 gap-6 mb-8">
          <StratumCard hover className="p-6">
            <div className="flex items-start justify-between">
              ...
              <FileImage className="w-8 h-8" style={{ color: '#C9A84C', opacity: 0.3 }} />
            </div>
          </StratumCard>
          ...
          <StratumCard hover className="p-6">
            <div className="flex items-start justify-between">
              ...
              <span className="text-3xl" style={{ color: '#C9A84C', opacity: 0.3 }}>
                ꓷ
              </span>
            </div>
          </StratumCard>
          ...
          <StratumCard hover className="p-6">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p
                  className="text-4xl"
                  style={{ fontFamily: 'Cinzel, serif', color: '#2AFC98' }}
                >
                  8/12
                </p>
              </div>
              <span className="text-3xl" style={{ color: '#2AFC98', opacity: 0.3 }}>
                ⊕
              </span>
            </div>
          </StratumCard>
        ...
        <StratumCard className="p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              className="px-4 py-2 transition-all hover:border-opacity-100"
              style={{
            ...
            <table className="w-full">
              <thead>
                ...
                >
                  ...
                  <th className="pb-3 px-3">Date de création</th>
                  <th className="pb-3 px-3">GPS</th>
                  <th className="pb-3 px-3">Auteur</th>
                ...
                {tableData.map((row, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-3 text-sm">
                      <span style={{ color: row.gps === 'Oui' ? '#2AFC98' : '#7A7060' }}>
                        {row.gps}
                      </span>
                    </td>
                    <td
