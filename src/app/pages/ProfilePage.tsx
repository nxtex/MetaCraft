        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-3 space-y-6">
            <StratumCard className="p-6">
              <motion.div
                className="w-32 h-32 mx-auto mb-4 rounded-full flex items-center justify-center relative overflow-hidden"
                style={{
              ...
              >
                <User className="w-16 h-16" style={{ color: '#080A0F' }} />
                <motion.div
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between p-4" style={{ backgroundColor: '#141C2A' }}>
                          <span style={{ fontFamily: 'IBM Plex Mono, monospace', color: '#EDE8DC' }}>
                      ...
                      <div className="space-y-3">
                        {['Nouveaux artefacts', 'Modifications sauvegardées', 'Analyses terminées'].map((item) => (
                          <div key={item} className="flex items-center justify-between p-4" style={{ backgroundColor: '#141C2A' }}>
                            <span style={{ fontFamily: 'IBM Plex Mono, monospace', color: '#EDE8DC', fontSize: '14px' }}>
                              {item}
                            </span>
                            <label className="relative inline-block w-12 h-6">
                              <input type="checkbox" className="sr-only peer" defaultChecked />
                    ...
                    >
                      <StratumCard hover className="p-6">
                        <div className="flex items-start justify-between">
                          ...
                          <stat.icon className="w-12 h-12" style={{ color: stat.color, opacity: 0.3 }} />
                        </div>
                      </StratumCard>
                    </motion.div>
                  ))}
