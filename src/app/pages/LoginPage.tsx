...
import { Mail, Lock, AlertCircle, Loader2, Brush } from 'lucide-react';
...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#080A0F' }}>
      <motion.div className="w-full max-w-[440px]"
        ...
        <div style={{ backgroundColor: '#141C2A', border: '1px solid rgba(201,168,76,0.2)', padding: '32px' }}>
          <h1 className="text-2xl mb-1" style={{ fontFamily: 'Cinzel, serif', color: '#EDE8DC' }}>Connexion</h1>
          <p className="mb-6 text-sm" style={{ fontFamily: 'IBM Plex Mono, monospace', color: '#7A7060' }}>Accédez à vos artefacts numériques</p>
          ...
          <p className="mt-5 text-center text-sm" style={{ fontFamily: 'IBM Plex Mono, monospace', color: '#7A7060' }}>
            Pas de compte ?{' '}
            <Link to="/signup" style={{ color: '#C9A84C', textDecoration: 'none' }}>Créer un compte</Link>
          </p>
        </div>
      </motion.div>
    </div>
