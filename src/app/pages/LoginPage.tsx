...
import { Mail, Lock, AlertCircle, Loader2, Layers } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div className="bg-[#111111] border border-[#1a1a1a] p-10">
          <div className="mb-8">
            <h1 className="font-cinzel text-3xl text-[#f5f5f5] mb-2">Connexion</h1>
            <p className="text-[#8a8a8a] text-sm font-ibm-plex-mono">
              Accedez a vos artefacts numeriques
            </p>
          </div>
